...
## Dual Licensing
The **Community Edition** of this project is licensed under the **Apache License 2.0**.

The **Enterprise Edition**, which includes additional performance modules, GPU backends,  
